    ...
    const onpressback =()=>{
      ...
      return (
        ...
        <View style={Styles.card}>
                ...
                <Text style={Styles.baseTextH2}> Your Articles  has been added successfully.</Text>
           
            </View>
            
        </View>
        <CustomButton text="Back To  Articles"  onPress={ onpressback}  />
       </View>
...
export default Succusesfullemp