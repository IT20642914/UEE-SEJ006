    ...
    const onpressback =()=>{
      ...
      return (
        ...
        <View style={Styles.card}>
                ...
                <Text style={Styles.baseTextH2}> Your Job  Location  has been added successfully.</Text>
           
            </View>
            
        </View>
        <CustomButton text="Back To View All Job Locations"  onPress={ onpressback}  />
       </View>
...
export default SuccesssmgsjLocation